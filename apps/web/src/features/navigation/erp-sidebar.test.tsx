...
describe("ErpSidebar", () => {
  it.each<ErpSection>(["dashboard", "research", "competitors", "products", "design", "stores", "listings", "orders", "inventory", "procurement", "supplier-performance", "channel-inventory", "finance"])(

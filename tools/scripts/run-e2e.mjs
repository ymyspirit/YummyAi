...
const configs = joined.includes("capture")
  ...
  : joined.includes("p0-flow") || joined.includes("tenant-isolation") || joined.includes("inventory") || joined.includes("procurement") || joined.includes("pod-batch-workbenches") || joined.includes("amazon-report") || joined.includes("production-editor") || joined.includes("navigation") || joined.includes("canvas-bridge")
